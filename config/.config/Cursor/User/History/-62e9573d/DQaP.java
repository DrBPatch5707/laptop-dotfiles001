...
public class Projectmanager extends ProjectManagerGUI{
    ...
    protected void setupEventHandlers() {
        ...
        addProjectButton.addActionListener(e -> {
            ...
            dialogOpen = true;
            String rootDir = backend.getRootDir();
            AddEditProjectDialog dialog = new AddEditProjectDialog(this, rootDir, (project, isEdit) -> {
                try {
            ...
            // Add window listener to reset the flag when dialog closes
        ...
        settingsButton.addActionListener(e -> {
            new SettingsDialog(this, backend.getRootDir()).setVisible(true);
        });
    }
