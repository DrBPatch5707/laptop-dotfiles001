...
public class Project {
    ...
    /**
     * Relative path from the projects root directory to this project's directory.
    ...
    /**
     * Flag indicating if the project directory already exists.
     * Used to determine whether to create the directory when adding the project.
     */
    ...
    /**
     * Gets the directory exists flag.
    ...
    /**
     * Sets the directory exists flag.
     * @param dirExists true if the directory already exists, false otherwise
     */
