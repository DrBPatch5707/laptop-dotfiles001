 ...
 * @version 1.0
 */
public class TestBackendService implements BackendInterface {
    ...
    public TestBackendService() {
        // Note: initialize() should be called explicitly
    }
    ...
    public void initialize() throws Exception {
        initializeTestData();
        System.out.println("Test backend initialized successfully");
    }
    
    @Override
    public void shutdown() throws Exception {
        System.out.println("Test backend shutting down");
        // In a real implementation, you would save data, close connections, etc.
    }
    ...
    public void updateProject(Project project) throws Exception {
        ...
        throw new Exception("Project not found for update: " + project.getName());
    }
    ...
    public void deleteProject(Project project) throws Exception {
        boolean removed = projects.removeIf(p -> p.getId() == project.getId());
        if (removed) {
            System.out.println("Deleted project: " + project.getName() + " (ID: " + project.getId() + ")");
        } else {
            throw new Exception("Project not found for deletion: " + project.getName());
        }
    }
    ...
    public void updateEditorProfile(EditorProfile profile) throws Exception {
        ...
        throw new Exception("Editor profile not found for update: " + profile.getName());
    }
    ...
    public void deleteEditorProfile(EditorProfile profile) throws Exception {
        boolean removed = editorProfiles.removeIf(p -> p.getName().equals(profile.getName()));
        if (removed) {
            System.out.println("Deleted editor profile: " + profile.getName());
        } else {
            throw new Exception("Editor profile not found for deletion: " + profile.getName());
        }
    }
