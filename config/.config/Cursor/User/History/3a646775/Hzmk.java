...
public class GUI_Connection implements BackendInterface{
    ...
    private String rootDirectory = "projects";
    ...
    public void addProject(Project project) throws Exception {
        ...
        try(PreparedStatement pstmt = Main.connection.prepareStatement(stmt)) {
            ...
            if (rowsAffected > 0) {
                ...
                // Add to in-memory list for immediate GUI update
    ...
    public void setRootDirectory(String path) throws Exception {
        if (path == null || path.isBlank()) throw new IllegalArgumentException("Root directory cannot be empty");
        rootDirectory = path;
    }
