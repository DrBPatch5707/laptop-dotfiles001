...
class TestProjectManagerGUI extends ProjectManagerGUI {
    ...
    private void setupTestEventHandlers() {
        // Clear existing event handlers and set up new ones
        addProjectButton.removeActionListener(addProjectButton.getActionListeners()[0]);
        editProjectButton.removeActionListener(editProjectButton.getActionListeners()[0]);
        deleteProjectButton.removeActionListener(deleteProjectButton.getActionListeners()[0]);
        openFolderButton.removeActionListener(openFolderButton.getActionListeners()[0]);
        openWithButton.removeActionListener(openWithButton.getActionListeners()[0]);
        ...
        openFolderButton.addActionListener(e -> openProjectFolder());
        openWithButton.addActionListener(e -> openProjectWith());
    ...
    public void openProjectFolder() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Error opening project folder: " + e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
        ...
        if (selectedEditor != null) {
            ...
            if (editor != null) {
                try {
                    ...
                    JOptionPane.showMessageDialog(this, "Error opening project with editor: " + e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
        }
    }
