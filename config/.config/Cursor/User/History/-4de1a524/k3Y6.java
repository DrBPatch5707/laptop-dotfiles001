...
public class BackendAPI {
    ...
    public static boolean removeIDE(String ideId) {
        ...
        IDE removed = Config.getIdes().remove(ideId);
        return removed != null;
    }
    
    public static IDE getIDEById(String ideId) {
        return Config.getIdes().get(ideId);
    }
    ...
    public static void addIDE(IDE ide) {
        Config.addIde(ide.getName(), ide);
    }
