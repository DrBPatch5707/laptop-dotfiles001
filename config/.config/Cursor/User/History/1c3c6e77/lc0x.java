...
public class ProjectManagerGUI extends JFrame {
    ...
    private void initMenu() {
        ...
        setRootMenuItem = new JMenuItem("Set Root Directory");
        setRootMenuItem.addActionListener(e -> showSetRootDialog());
    ...
    private void showSetRootDialog() {
        String newRoot = JOptionPane.showInputDialog(this, "Enter new root directory:", BackendAPI.root);
        if (newRoot != null && !newRoot.trim().isEmpty()) {
            BackendAPI.setRoot(newRoot.trim());
