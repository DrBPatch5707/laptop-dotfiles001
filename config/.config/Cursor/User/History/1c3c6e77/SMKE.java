...
class SettingsDialog extends JDialog {
    ...
    private void addIDE(DefaultListModel<String> model) {
        ...
        if (form.isConfirmed()) {
            ...
            Config.addIde(newIDE.getId(), newIDE);
            model.addElement(newIDE.getName());
    ...
    private void editIDE(JList<String> list, DefaultListModel<String> model) {
        ...
        if (form.isConfirmed()) {
            ...
            // Update the IDE in the config
            Config.addIde(updatedIDE.getId(), updatedIDE);
            model.setElementAt(updatedIDE.getName(), selectedIndex);
