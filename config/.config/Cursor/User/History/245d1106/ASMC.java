...
public class DbConnection {
    ...
    public static boolean updateProjectName(int projectId, String newName) {
        ...
        try (PreparedStatement pstmt = Main.connection.prepareStatement(stmt)) {
            ...
            int rowsAffected = pstmt.executeUpdate();
            if (rowsAffected > 0) {
                System.out.println("Updated project name in database: ID=" + projectId + ", new name='" + newName + "'");
                return true;
            } else {
                System.out.println("Project not found in database: ID=" + projectId);
                return false;
            }
        } catch (SQLException e) {
            System.out.println("Error updating project name in database: " + e.getMessage());
            return false;
        }
    }
    ...
    public static boolean updateProjectLastModified(int projectId, String lastModifiedDate) {
        ...
        try (PreparedStatement pstmt = Main.connection.prepareStatement(stmt)) {
            ...
            int rowsAffected = pstmt.executeUpdate();
            if (rowsAffected > 0) {
                System.out.println("Updated last modified date in database: ID=" + projectId + ", date='" + lastModifiedDate + "'");
                return true;
            } else {
                System.out.println("Project not found in database: ID=" + projectId);
                return false;
            ...
            System.out.println("Error updating last modified date in database: " + e.getMessage());
            return false;
        }
    }
    //endregion
