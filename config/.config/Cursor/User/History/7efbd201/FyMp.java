 ...
 * - Manual relative path input for project directory
 ...
 * - Relative paths are entered directly by the user</p>
 * 
...
public class AddEditProjectDialog extends JDialog {
    ...
    /**
     * The root directory for projects (provided by backend)
     */
     ...
     * @param rootDirectory The root directory for projects
     * @param saveCallback Callback to invoke when project is saved
     */
    public AddEditProjectDialog(JFrame parent, String rootDirectory, ProjectSaveCallback saveCallback) {
        this(parent, rootDirectory, null, saveCallback);
    }
     ...
     */
    public AddEditProjectDialog(JFrame parent, String rootDirectory, Project project, ProjectSaveCallback saveCallback) {
    ...
    private void createComponents() {
        ...
        pathField.setToolTipText("Enter the relative path to the project directory (e.g., 'myproject' or 'projects/webapp')");
    ...
    private void layoutComponents() {
        ...
        // Show root directory at the top
        JPanel rootPanel = new JPanel(new FlowLayout(FlowLayout.LEFT));
        rootPanel.add(new JLabel("Root Directory: "));
        rootPanel.add(new JLabel(rootDirectory));
    ...
    private void saveProject() {
        ...
        if (path.isEmpty()) {
            JOptionPane.showMessageDialog(this,
                "Project path is required. Please enter a relative path to the project directory.",
                "Validation Error",
                JOptionPane.ERROR_MESSAGE);
        ...
        if (path.startsWith("/") || path.startsWith("\\")) {
            JOptionPane.showMessageDialog(this,
                "Project path must be relative, not absolute.",
                "Validation Error",
                JOptionPane.ERROR_MESSAGE);
            pathField.requestFocus();
            return;
        ...
        // Check for duplicate path (case-insensitive)
        for (Project p : DataBank.projects) {
            if (!isEditMode || (originalProject == null) || !p.equals(originalProject)) {
                if (p.getRelativePath() != null && p.getRelativePath().equalsIgnoreCase(path)) {
                    JOptionPane.showMessageDialog(this,
        ...
        project.setRelativePath(path); // Path is already relative to root directory
