...
public class init {
    ...
    private static void syncDatabaseWithFilesystem() {
        ...
        for (Project project : projectsToRemove) {
            ...
            // Note: We don't call BackendAPI.deleteProject() here as it would try to delete the filesystem directory
            // Instead, we just remove from the in-memory map and let the database be updated on next save
        }
