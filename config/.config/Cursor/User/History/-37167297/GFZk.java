    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            if (!Files.exists(Settings.rootConfPath)) {
                ...
                System.out.println("Please set the root directory through the Settings menu in the GUI");
            } else {
                System.out.println("Reading root from file: " + Settings.rootConfPath);
                ...
                if (!savedRoot.isEmpty()) {
                    ...
                    System.out.println("Root file is empty, please set it through the Settings menu");
                }
            }
        } catch (Exception e) {
